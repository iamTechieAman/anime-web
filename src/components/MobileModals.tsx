...
const quickLinks = [
    { name: "Discover AI ✨", href: "/discover", icon: Compass, color: "from-orange-500 to-amber-500" },
                        ...
                        >
                            ...
                            <div className="p-5 overflow-y-auto">
                                ...
                                <div className="space-y-3 mb-6">
                                    ...
                                    {/* Features Info */}
                                    <div className="p-3 bg-gradient-to-r from-orange-500/5 to-amber-500/5 rounded-xl border border-[var(--border-color)]">
                                        <div className="flex items-center gap-2 text-[10px] font-bold text-orange-400 uppercase tracking-tight">
                                ...
                                <div className="flex gap-2 overflow-x-auto scrollbar-none pb-2 -mx-1 px-1" style={{ WebkitOverflowScrolling: 'touch' }}>
                                    {["Action", "Romance", "Comedy", "Fantasy", "Thriller", "Sci-Fi", "Horror", "Drama", "Mystery", "Adventure"].map((genre, i) => (
                                        <button 
                                            ...
                                            className="px-4 py-2 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl text-xs font-bold text-[var(--text-muted)] hover:text-orange-400 hover:border-orange-500/50 transition-colors active:scale-95 shrink-0"
                                        >
                                            {genre}
                                        </button>
                                    ))}
