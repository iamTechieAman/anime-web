...
export default function RandomizerFloatingTrigger() {
    ...
    return (
        <motion.div
            ...
            className="group fixed right-4 bottom-20 md:right-6 md:bottom-6 z-40 pointer-events-auto hide-scrollbar"
        >
            {/* Pulse wave overlay */}
            ...
            <button
                ...
                className="relative flex items-center justify-center h-12 w-12 rounded-full bg-gradient-to-tr from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white shadow-[0_0_20px_rgba(236,72,153,0.45)] border border-pink-500/30 transition-all duration-[250ms] cursor-pointer active:scale-90 hide-scrollbar"
            >
            ...
            {/* Premium Tooltip */}
            <div className="absolute right-14 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-[#12131A] border border-white/10 rounded-lg text-white text-[10px] font-black tracking-wider uppercase whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none shadow-2xl">
