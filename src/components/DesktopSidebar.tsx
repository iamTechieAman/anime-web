...
export default function DesktopSidebar() {
    ...
    return (
        <aside className="peer/sidebar group fixed left-0 top-0 bottom-0 w-[80px] hover:w-[280px] transition-[width] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] bg-[#08080B]/95 backdrop-blur-md border-r border-white/5 hidden md:flex flex-col py-6 z-[60]">
            {/* Branded Logo */}
