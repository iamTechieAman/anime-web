            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10 border-b border-white/5 pb-8">
                <div>
                    <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-white to-zinc-400 bg-clip-text text-transparent flex items-center gap-3">
                        <Activity className="w-8 h-8 text-[#FF9D00] animate-pulse" />
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#FF9D00] to-[#FFB333] hover:from-[#e08a00] hover:to-[#e09e2e] active:scale-98 text-black font-black uppercase text-xs tracking-wider px-5 py-3 rounded-xl transition-all shadow-[0_8px_25px_rgba(255,157,0,0.25)] border-0 disabled:opacity-50 cursor-pointer"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-4">
                    <h2 className="text-lg font-black uppercase tracking-wider text-zinc-300 flex items-center gap-2 mb-2">
                        <Zap className="w-5 h-5 text-[#FF9D00]" />
                    ...
                    {isLoading ? (
                        ...
                        <div className="bg-[#0c0d14]/50 border border-white/5 rounded-2xl p-10 text-center">
                            ...
                            <button onClick={triggerPing} className="mt-4 text-xs font-black uppercase text-[#FF9D00]">Check Status Now</button>
                        </div>
                    ) : (
                        providers.map((p) => {
                                        ...
                                        <div key={c.name}>
                                            <div className="flex items-center justify-between bg-white/[0.02] border border-white/5 rounded-xl p-3">
                                                <div className="flex items-center gap-2.5">
                                                    <span className="w-5 h-5 flex items-center justify-center rounded-full bg-[#FF9D00]/10 text-[#FF9D00] text-[10px] font-black">
                                                        {c.step}
                                                    </span>
