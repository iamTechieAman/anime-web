  ...
  return (
    <div className="min-h-dvh bg-[var(--bg-main)] text-[var(--text-main)] flex flex-col items-center justify-center p-4 text-center z-50 relative">
      <div className="max-w-md w-full bg-[var(--bg-card)] border border-[var(--border-color)] rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
        {/* Background glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-32 bg-[var(--accent-warm)]/20 blur-3xl rounded-full" />
        ...
        <div className="relative z-10 flex flex-col items-center">
            ...
            <h1 className="text-6xl font-black mb-2 text-transparent bg-clip-text bg-gradient-to-r from-[var(--accent)] to-[var(--accent-warm)] font-sora">404</h1>
            ...
            <div className="flex flex-col w-full gap-3">
                <Link
                    href="/"
                    className="w-full flex items-center justify-center gap-2 bg-[var(--accent-warm)] text-white py-3.5 rounded-xl font-bold hover:bg-[var(--accent-warm)] transition-colors active:scale-95 shadow-lg shadow-[var(--accent-warm)]/20"
                >
