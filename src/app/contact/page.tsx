            ...
            <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start gap-4 p-5 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl group hover:border-purple-500/30 transition-all">
                            ...
                            <div>
                                ...
                                <button className="px-4 py-2 bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-bold rounded-lg hover:bg-purple-500 hover:text-white transition-all">Report Content</button>
                            </div>
                        </div>
                    </div>
