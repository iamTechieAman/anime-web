        ...
        <main className="min-h-screen bg-[var(--bg-main)] text-[var(--text-main)] font-sans">
            ...
            <div className="fixed top-0 left-0 md:left-[72px] right-0 z-50 px-4 py-3 bg-[var(--bg-overlay)] backdrop-blur-xl border-b border-[var(--border-color)]">
                <div className="max-w-7xl mx-auto flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="font-bold text-lg">Browse: <span className="text-purple-400">{displayLetter}</span></h1>
            ...
            <div className="pt-20 pb-24 md:pb-12 max-w-7xl mx-auto px-4 md:px-6 space-y-6">
                {/* A-Z Filter Bar */}
                    ...
                    {loading ? (
                        ...
                        >
                            <div className="relative">
                                <div className="absolute inset-0 bg-purple-600/20 blur-2xl rounded-full scale-150 animate-pulse" />
                        ...
                        >
                            <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-8 max-w-md">
                                ...
                                <button
                                    ...
                                    className="px-6 py-2.5 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-colors font-bold"
                                >
                                    Retry
                                </button>
                            </div>
